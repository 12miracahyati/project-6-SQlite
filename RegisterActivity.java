...
import com.miracahyati.sqlite.databinding.ActivityRegisterBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnRegister.setOnClickListener(view -> {
            ...
            if (password.equals(confPass)) {
                ...
                Toast.makeText(RegisterActivity.this,"Password is Not Macthing ", Toast.LENGTH_SHORT).show();
            }
        });
    }
}